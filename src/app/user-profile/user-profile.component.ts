...
export class UserProfileComponent implements OnInit {
 ...
 india=[
  ...
  submitSignUp() {
    ...
    this.userService.postStudent(this.signUpForm.value).subscribe(
        suc=>{},err=>{}
...
delete(id){
    this.userService.deleteStudent({id:id}).subscribe(
        res=>{if(res.status===true){
            window.alert("Deleted");
        }
            else{
                window.alert("Not Deleted");
            }
        },err=>{window.alert("Not Deleted");}
